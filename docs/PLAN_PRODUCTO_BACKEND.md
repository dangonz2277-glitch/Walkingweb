...
### 2. Cerrar el perímetro del sitio — bloqueante de publicación (En progreso - Orden 06B completada)
...
Probar acceso directo a la URL de un JS/JSON sin sesión. **Terminado cuando:** una petición anónima no puede obtener el contenido protegido, el proxy bloquea sin fallar (500) ante cookies inválidas, y las redirecciones respetan el host de origen. (Validado tras Orden 06B).
